...
##' @param id which row of the array to plot
##' @param hauteur width of the plate to put correct hrf
##' @param Zf Zf to put correct hrf
##' @param dist.bas application distance to put correct hrf
##' @param reconstruct option to reconstruct or not the image
##' @param ylim.raster optin to control the width of the image to reconstruct
##' @param main optionnal title
##' @param xlim optionnal xlim to zoom in 
##' @param channel plot a single channel
